                    ...
                    _data.delete('checks', checkId, function(err) {
                      ...
                      if(checksToDeleted == checksToDelete) {
                        if(!deletionError) {
                          ...
                          callback(500, {'Error':'all checks may not have been deleted from the userChecks'});
                        }
                      }
                    });
                  });
...
// container for all of the check methods
handlers._checks = {};
    ...
    _data.read('tokens', token, function(err, tokenData) {
      if(!err && tokenData) {
        ...
        _data.read('users', userPhone, function(err, userData) {
          if(!err && userData) {
            var userChecks = typeof(userData.checks) == 'object' && userData.checks instanceof Array ? userData.checks : [];
            // verify that the user has the maxChecks
...
// check - put
// required data: id
// optional data: protocol, url, method, successcodes, timeoutSecond
